...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aubiz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"aubiztools.com", "dnsseed.aubiztools.com"},
    {"aubizpool.org", "dnsseed.aubizpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"aubiztools.com", "testnet-seed.aubiztools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aubiz is probably already running."), addrBind.ToString().c_str());
        else
